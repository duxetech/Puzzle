...
import com.duxetech.puzzlestopuzzle.activities.act_riddles;
 ...
 */
public class frag_riddles extends Fragment {
    TextView tv;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        List<Quiz> list ;
        list = t.getRiddlesQuiz(getActivity());
        ...
        ad_rv_vertical adapter = new ad_rv_vertical(this.getActivity(),t.getTitle(list),act_riddles.class);
